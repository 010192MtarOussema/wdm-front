...
@Component({
  selector: 'app-alerte-equipement',
  templateUrl: './alerte-equipement.component.html',
  styleUrls: ['./alerte-equipement.component.sass']
})
export class AlerteEquipementComponent extends UnsubscribeOnDestroyAdapter
implements OnInit
{
displayedColumns = [
  'select',
