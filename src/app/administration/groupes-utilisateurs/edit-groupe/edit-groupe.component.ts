...
@Component({
  ...
  styleUrls: ['./edit-groupe.component.sass']
})
export class EditGroupeComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  displayedColumns = [
  ...
  constructor(private formBuilder: FormBuilder,
    public httpClient: HttpClient, private authorisationService: AuthorizationService,
