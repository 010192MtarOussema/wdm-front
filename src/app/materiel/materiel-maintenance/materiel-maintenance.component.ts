...
@Component({
  selector: 'app-materiel-maintenance',
  templateUrl: './materiel-maintenance.component.html',
  styleUrls: ['./materiel-maintenance.component.sass']
})
export class MaterielMaintenanceComponent extends UnsubscribeOnDestroyAdapter
  implements OnInit {
  displayedColumns = [
    'select',
    'id',
