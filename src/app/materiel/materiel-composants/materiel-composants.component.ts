...
@Component({
  selector: 'app-materiel-composants',
  templateUrl: './materiel-composants.component.html',
  styleUrls: ['./materiel-composants.component.sass']
})
export class MaterielComposantsComponent  extends UnsubscribeOnDestroyAdapter
implements OnInit
{
displayedColumns = [
  'select',
