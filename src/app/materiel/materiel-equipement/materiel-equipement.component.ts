...
@Component({
  ...
  templateUrl: './materiel-equipement.component.html',
  styleUrls: ['./materiel-equipement.component.sass']
})
export class MaterielEquipementComponent extends UnsubscribeOnDestroyAdapter
implements OnInit
{
displayedColumns = [
  'select',
