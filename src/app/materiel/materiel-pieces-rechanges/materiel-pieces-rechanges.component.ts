...
@Component({
  ...
  templateUrl: './materiel-pieces-rechanges.component.html',
  styleUrls: ['./materiel-pieces-rechanges.component.sass']
})
export class MaterielPiecesRechangesComponent extends UnsubscribeOnDestroyAdapter
implements OnInit
{
displayedColumns = [
  'select',
